...
class BotsCommands(BaseCog):
    ...
    async def show_help(self, ctx: bridge.BridgeApplicationContext):
        ...
        async def get_home_page():
            ...
            embed.set_footer(
                text=FOOTER+random.choice(lang.SHOW_HELP_FOOTER_HOME))

            view = self.bot.add_bot(CustomView(
                select, bot_button, server_button, github_button, timeout=300))
            return embed
    ...
    @bridge.bridge_command(name="ping", description="Gets the bot's ping.",
    ...
    @bridge.bridge_command(name="invite", aliases=["botinvite", "support"],
    ...
    @bridge.bridge_command(name="botinfo", aliases=["about", "specs", "botspecs"],
    ...
    @bridge.bridge_command(name="tip", description="Tip the creator of the bot.",
    ...
    @bridge.bridge_command(name="prefix", description="Changes the prefix.",
                           description_localizations={
                               "fr": "Change le préfixe."},
    ...
    @bridge.bridge_command(name="lang", aliases=["language"], description="Changes the bot's language.",
    ...
    @bridge.bridge_command(name="plugins", aliases=["plugin"],
